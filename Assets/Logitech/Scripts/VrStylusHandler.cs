...
public class VrStylusHandler : StylusHandler
{
    ...
    [SerializeField] private GameObject _controller_tip;
    ...
    private void UpdatePose()
    {
        ...
        _controller_tip.SetActive(!_stylus.isActive);
        ...
        if (!_stylus.isActive)
        {
            _stylus.inkingPose.position = _controller_tip.transform.position;
            _stylus.inkingPose.rotation = _controller_tip.transform.rotation;
        }
    }
    ...
    void Update()
    {
        ...
        {
            _stylus.tip_value = OVRInput.Get(OVRInput.Axis1D.PrimaryIndexTrigger, OVRInput.Controller.RTouch);
            _stylus.cluster_front_value = OVRInput.Get(OVRInput.Button.PrimaryHandTrigger, OVRInput.Controller.RTouch);
            _stylus.cluster_back_value = OVRInput.Get(OVRInput.Button.One, OVRInput.Controller.RTouch);
        }
